...
vecs<-read.csv("C:\\Users\\Tony\\Dropbox\\Rowan\\DM2\\Lecture12\\vecs2a.txt",header=FALSE,stringsAsFactors=TRUE)

dim(vecs)
vecs2 <-t(vecs)
vecs2[1:5,1:5]

vecs3<-as.data.frame(vecs2[2:1001,])
vecs3[1:5,1:5]
...
mymatrix <- matrix(nrow=1000,ncol=1292)
